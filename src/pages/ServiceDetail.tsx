      ...
      <section className="relative overflow-hidden bg-dark pt-32 pb-16 lg:pt-40 lg:pb-20">
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="absolute inset-y-0 right-0 h-full w-full lg:w-[62%] object-cover"
            width={1200}
            height={800}
            fetchPriority="high"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-dark via-dark/85 to-dark/10 lg:to-transparent" />
