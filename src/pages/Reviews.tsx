      ...
      <section className="relative w-full overflow-hidden bg-black">
        ...
        <div className="absolute inset-0">
          <img
            ...
            fetchPriority="high"
          />
          {/* Gradient overlay - dark left to transparent right for image visibility */}
          <div className="absolute inset-0 bg-gradient-to-r from-black via-black/40 via-black/15 to-black/5" />
        </div>
